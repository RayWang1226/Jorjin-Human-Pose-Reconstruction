...
MAX_FRAMES_KEEP_POSE = 600 #original not define
consecutive_frames = 10 # original use args.consecutive_frames in line 305 but there's no args in live_demo.py
####################2025.06.18 test (tun-chuan adding)#########################
    ...
    while True:
        ...
        if hand_result.multi_hand_landmarks and hand_result.multi_handedness:
            for landmarks, handedness_info in zip(hand_result.multi_hand_landmarks, hand_result.multi_handedness):
                ...
                if (hand_pose_tracking[handedness]["consecutive_count"] >= consecutive_frames and
